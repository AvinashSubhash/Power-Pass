...
def run_gui():
    ...
    field_two = tk.Label(text = "Enter any Number (Birthdate/year/code etc) : ",width=35,height=2,foreground="#000000",background="#ffffff",font=('systemfixed',12,"bold"))
    field_two.place(x=20,y=250)
